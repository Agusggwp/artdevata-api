...
<head>
  ...
  <title>Kelola Layanan - AdminPro</title>
  ...
  <div class="flex h-screen overflow-hidden">
    ...
    <div id="sidebar" class="fixed inset-y-0 left-0 z-50 w-64 bg-white dark:bg-gray-800 shadow-2xl transform -translate-x-full lg:translate-x-0 lg:static lg:inset-0 transition-transform duration-300 ease-in-out">
      ...
      <nav class="mt-6">
        ...
        <a href="{{ route('admin.services.index') }}" class="flex items-center px-6 py-3 text-gray-700 dark:text-gray-300 sidebar-hover sidebar-active rounded-l-full mr-3">
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
      ...
      <main class="flex-1 overflow-y-auto p-4 lg:p-8">
        ...
        <!-- Tombol Tambah -->
        <div class="mb-6">
          <a href="{{ route('admin.services.create') }}" class="btn bg-gradient-to-r from-primary to-secondary text-white hover:shadow-lg">
