...
<div class="flex items-center justify-between mb-6">
  <div>
    <h1 class="text-xl font-bold text-slate-900">Edit Peran / Role</h1>
    <p class="text-xs text-slate-700 font-medium">Perbarui kewenangan dan matriks izin akses untuk peran {{ $role->name }}</p>
  </div>
    ...
    <div class="pt-4 border-t border-slate-200">
      <div class="flex items-center justify-between mb-4">
        <div>
          ...
          <p class="text-xs text-slate-600">Atur hak izin yang diberikan untuk peran ini</p>
        </div>
        <div class="space-x-3">
          ...
          <button type="button" onclick="toggleAllPermissions(false)" class="text-xs text-rose-600 font-bold hover:underline">Hapus Semua</button>
        </div>
      </div>
